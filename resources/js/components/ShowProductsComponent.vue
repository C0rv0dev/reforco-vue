<script>
    export default {
        ...
        methods: {
            ...
            saveNote() {
                axios.post(`products/${this.product.id}/notes`, {
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button @click="$emit('deleteProduct')" class="btn btn-sm btn-danger me-2 float-end">
                            <font-awesome-icon icon="fa-solid fa-trash"></font-awesome-icon>
                        </button>
                        <button @click="isCreatingNote = true" class="btn btn-sm btn-primary me-2 float-end">
                            <font-awesome-icon icon="fa-solid fa-plus"></font-awesome-icon>
                            Note
                        </button>
                        <button @click="isEditing = true" class="btn btn-sm btn-warning me-2 float-end">
                    ...
                    <div class="card-body">
                        ...
                        <div v-if="isEditing">
                            <input class="form-control w-50 float-start" type="text" name="newProductPrice"
                                v-model="newProduct.price">
                            <input class="form-control w-50 float-end" type="text" name="newProductQuantity"
                                v-model="newProduct.quantity">
                            <button @click="editProduct(), $emit('clear')"
                                class="btn btn-sm float-end btn-success mt-3">
                        ...
                        <div v-if="isCreatingNote">
                            ...
                            <button @click="isCreatingNote = false" class="btn btn-danger btn-sm mt-2">
                                <font-awesome-icon icon="fa-solid fa-xmark"></font-awesome-icon>
                            </button>
                            <button @click="isCreatingNote = false, saveNote()"
